                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="md md-settings"></i><span> Settings </span><span class="pull-right"><i class="md md-add"></i></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="settings/aviary.php">Aviary</a></li>
                                    <li><a href="settings/cage.php">Cage</a></li>
                                    <li><a href="settings/group.php">Group</a></li>
                                    <li><a href="settings/species.php">Species</a></li>
                                    <li><a href="settings/proven.php">Proven</a></li>
                                    <li><a href="settings/bird.php">Bird</a></li>
                                </ul>
                            </li>
